const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'static/index-C36Lp-s9-Cp4oucSK.js',
      'static/index-DhNcsB17.js',
      'static/index-Kjxpn7dk.css',
      'static/index-DvET0jGm.js',
      'static/ChainAdapterBlueprint-BPyzxDqE.js',
      'static/index-BfX5X6AK.js',
      'static/index-nibyPLVP.js',
    ]),
) => i.map((i) => d[i])
import { r as d, bc as m } from './index-DhNcsB17.js'
const _ = '2.36.0'
let u = {
  ...
  async init() {
    if (!(this.initialized || this._initializing)) {
      if (
        ...
        this._wagmi ||
          (this._wagmi = await m(
            () => import('./index-C36Lp-s9-Cp4oucSK.js'),
        ...
        const { WagmiAdapter: e } = await m(
          async () => {
            const { WagmiAdapter: t } = await import('./index-DvET0jGm.js').then((a) => a.bp)
            return {
              WagmiAdapter: t,
            }
          },
      ...
      if (
        ...
        const { createAppKit: e } = await m(
          async () => {
            const { createAppKit: t } = await import('./index-BfX5X6AK.js').then((a) => a.k)
            return {
              createAppKit: t,
            }
          },
