...
const props = defineProps<BalanceConvertorProps>()
...
const clampAmount = (value: number) => Math.min(value, props.maxAmount)
...
<template>
  <div class="balance-convertor">
    ...
    <v-row no-gutters class="balance-convertor-row justify-center align-center">
      ...
      <v-col cols="12" sm="2" class="d-flex justify-center align-center balance-convertor-equal">
        <span>=</span>
      </v-col>
    ...
    <div class="balance-convertor-rate">
